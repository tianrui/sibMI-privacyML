...
def predictor(input_tensor=None, output_dim=10):
    ...
    return (pt.wrap(input_sample).
            reshape([FLAGS.batch_size, 1, 1, FLAGS.hidden_size]).
            fully_connected(100, activation_fn=tf.nn.sigmoid).
            fully_connected(output_dim, activation_fn=tf.nn.sigmoid)).tensor, mean, stddev
